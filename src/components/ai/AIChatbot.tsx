...
import {
    type AIMode, type ChatMessage, type CourseContext, type ChatSession,
    type StreamMetrics,
...
export default function AIChatbot({ courseContext }: AIChatbotProps) {
    ...
    // v2 Premium state
    const [availableModels, setAvailableModels] = useState<{ name: string; size: number; contextLength?: number }[]>([]);
    ...
    async function checkHealth() {
        ...
        setAiOnline(health.ollama === "connected");
    }
    ...
    async function handleSend() {
        ...
        await streamChat(
            ...
            controller.signal,
            (meta) => {
                if (meta.contextOptimized) {
                    setThinkingPhase("Optimizing context window...");
                }
            }
        );
    }
                    ...
                    >
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                                ...
                                <div>
                                    ...
                                    <div style={{
                                        ...
                                        {aiOnline === null ? "Checking..." : aiOnline ? `Online • ${model.split(":")[0]}` : "Offline"}
                                        {isWarmingUp && (
                                            ...
                                            >
                                                ...
                                                {availableModels.length > 0 ? (
                                                    ...
                                                    <div style={{
                                                        ...
                                                        No models detected.
                                                        <br />Run: <code style={{ color: "#a78bfa" }}>ollama pull llama3</code>
                                                    </div>
                                                )}
                                            </motion.div>
                                        )}
                            ...
                            {messages.length === 0 && !streamingText && (
                                <div style={{ textAlign: "center", padding: "30px 20px" }}>
                                    ...
                                    <div style={{
                                        ...
                                        <Zap size={10} /> {model.split(":")[0]} • {MODE_LABELS[mode].emoji} {MODE_LABELS[mode].label} Mode
                                    </div>
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                Powered by Ollama • Privacy-first • 100% local AI
                            </div>
                        </div>
                    </motion.div>
                )}
